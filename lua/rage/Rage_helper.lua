--[[
    ...
    # Reference: RageEssentials.lua(https://nixware.cc/threads/16812/);
...
local binds = {
	...
	{ name = 'Damage Override',     cfg = lua_re_mindmg_bind,        	 type = 'key_bind' },
...
local function keybinds(cmd)
	...
	for i = 1, #entity do
		...
		if lua_re_mindmg_bind:is_active() then
			ragebot.override_min_damage(player:get_index(), lua_re_mindmg:get_value())
		end
	end
